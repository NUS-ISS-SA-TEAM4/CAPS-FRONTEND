...
//Change from Student to Lecturer
export default function Lecturer() {
  ...
  const fetchData = async () => {
    try {
      ...
      //Change student -> lecturer
      if (path === "/lecturer/profile") {
        //Change students -> lecturers
        url = "http://localhost:8081/lecturers";
        setActiveTab("profile_Setting");
      }
      //Change student -> lecturer 
      //Change grades -> coursestaught
      //Course taught by the lecturer
      else if (path === "/lecturer/coursestaught") {
        url = "http://localhost:8081/course";
        setActiveTab("coursetaughtList");
      } 
      //Change student -> lecturer
      //Change course -> courseenrolment
      //Course enrolment -> View the list of students enrolled 
      else if (path === "/lecturer/courseenrolment") {
        url = "http://localhost:8081/course";
        setActiveTab("courseenrolmentList");
      } 
      //Change student -> lecturer
      //Change courseenrol -> grading
      else if (path === "/lecturer/grading") {
        url = "http://localhost:8081/course";
        setActiveTab("grading");
      }
      //Created student performance 
      else if (path === "/lecturer/studentperform"){
        url = "http://localhost:8081/studentperform";
        setActiveTab("studentperform")
      }
  ...
  const renderContent = () => {
    if (activeTab === "profile_Setting") {
              ...
              <tbody>
                {data.map((rowData) => (
                  <tr key={rowData.id}>
                    ...
                    <td>{rowData.email}</td>
                    {/* Included contact number */}
                    <td>{rowData.contactnumber}</td>
                    {/* Remove enromnent date */}
      ...
      // Update to Lecturer coursetaughtList
    } else if (activeTab === "coursetaughtList") {
      return (
        <div
          className={`tab-pane fade${
            activeTab === "coursetaughtList" ? " show active" : ""
          }`}
          id="coursetaughtList"
          role="tabpanel"
          aria-labelledby="coursetaughtList_tab"
        >
          <h2>View Course Taught:</h2>
          {/* <div className="tables-container">
    ...
    } else if (activeTab === "courseenrolmentList") {
      return (
        <div
          className={`tab-pane fade${
            activeTab === "courseList" ? " show active" : ""
            ...
            >
              ...
              >
                <a
                  ...
                  onClick={() => fetchData("/lecturer/profile")}
              ...
              >
                <a
                  ...
                  onClick={() => fetchData("/lecturer/grades")}
                  href="/student/grades"
                  role="tab"
                  aria-selected={activeTab === "gradesList"}
                >
